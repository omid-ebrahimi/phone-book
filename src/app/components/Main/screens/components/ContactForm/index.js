...
function ContactForm({handleSave, handleCancel, initialValues = defaultInitialValues}) {
                    ...
                    <Grid>
                        ...
                        <Row className='sticky bottom-0 mt1 z1'>
                            <CellCenter desktopColumns={4} tabletColumns={6} phoneColumns={4}
                                ...
                                <Button onClick={handleCancel} disabled={isSubmitting} className='col-5'
                                        style={{background: 'white'}} outlined>
                                    Cancel
                                </Button>
                                <Button onClick={submitForm} disabled={isSubmitting} className='col-5' raised>
                                    Save
                                </Button>
                            </CellCenter>
                        </Row>
